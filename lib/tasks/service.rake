namespace :service do
  ...
  task :daemons, [:command] do |task, args|
    @daemons = %w[ranger market_ticker withdraw_audit blockchain global_state deposit_collection deposit_collection_fees deposit_coin_address slave_book pusher_market pusher_member matching order_processor trade_executor withdraw_coin k]
